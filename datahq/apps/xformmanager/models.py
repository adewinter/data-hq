...
class Metadata(models.Model):
    ...
    def submitting_reporter(self):
        ...
        # TODO: The below fails, we don't have a handle to the reporter profile
        # object anymore.  This needs to be revisited.
        raise Exception("We no longer link reporters to submissions in this way!")
